<template>
  ...
  <aside
    class="fixed inset-y-0 left-0 z-[1001] flex w-[270px] flex-col justify-between overflow-y-scroll bg-secondary p-8 duration-[0.5s] sm:translate-x-[0] md:w-[30%] md:py-16 xl:w-[22%]"
